...
public class main {
        ...
        public static void main(String[] args) {
                ...
                Arraydenunciado.add(new denunciado("Atlantida", "El Rosario", "nuevacapital", "k", "3456", "casa34",
                                "Lester",
                ...
                Arrayofendido.add(
                                new ofendido("Atlantida", "El Rosario", "nuevacapital", "k", "3456", "casa34", "Lester",
                                                "Jhoan", "Dominguez", "Chavez", 21, "0311200200692", "Masculino"));
                ...
                ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                // Instanciar objeto QueryBBDD
                QueryBBDD queryBBDD = new QueryBBDD();

                // Insertar denunciantes en la base de datos
                queryBBDD.insertExpediente(objexpediente);

                // Llamar al método select para mostrar los resultados
                // queryBBDD.select();
